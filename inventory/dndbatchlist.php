                        ...
                        <div class="col-lg-12">
                            <div class="card mt-4">
                                <div class="card-header">
                                    <h4>Drinks and Desserts Batch List</h4>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "SELECT dndbatch.*, dnd.DND_NAME
                                                    FROM dndbatch
                                                    JOIN dnd ON dnd.DND_ID = dndbatch.DND_ID
                                                    ORDER BY dndbatch.EXP_DATE ASC";
                                            ...
                                            if(mysqli_num_rows($query)):?>
                                                ...
                                                ?>
                                                    <tr <?= $warning?>>
                                                        <td><?= htmlspecialchars($row['DB_ID'])?></td>
                                                        <td><?= htmlspecialchars($row['DND_NAME'])?></td>
                                                        <td><?= htmlspecialchars($row['DB_Q'])?></td>
